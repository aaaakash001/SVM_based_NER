...
vocab_threshold = 2  # Consider words with a frequency < 5 as unknown
...
with open('../param/dict_vectorizer_unk.pkl', 'rb') as vec_file:
    vectorizer = pickle.load(vec_file)
with open('../param/best_ner_model_unk.pkl', 'rb') as f:
    model = pickle.load(f)
